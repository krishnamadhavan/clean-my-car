...
**Gap today:** no implemented `/ops/*` routes; catalogs are seeded manually. Consumer error e.g. `pricing_not_found` means Module **6** master data is missing for that city.
